...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/python-sdk/releases/tag/v0.6.2">
    <img alt="Latest version" src="https://img.shields.io/static/v1?label=release&message=v0.6.2&color=blue&style=for-the-badge" />
  </a>
...
```bash
pip install openfeature-sdk==0.6.2
```
